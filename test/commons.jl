...
if !isdefined(Main, :Test)
    ...
    sentences = [
        ...
        narsese"<(*, A, B, C, D) --> R>? "
        narsese"「我是墓地」。现在真值=1.0真0.5信"han
        narsese"「「他是『爱因斯坦』」得「他似爱因斯坦」」"han
        narsese"「（与，「凉白开是水」，「水是有毒的」）得「凉白开是有毒的」」将来真值=0.8真0.3信"han
        narsese"「「（积，甲，乙）是（积，丙，丁）」将得（与，「甲是丙」，「乙是丁」）」？"han
        narsese"「「（积，『爱因斯坦』，专利局）是坐在」曾得「（外像，『爱因斯坦』，坐在，某）是专利局」」曾经真值=0.5真0.9信"han
        narsese"「「『我』是【好】」似（与，「我为【好】」，「『我』有好」，「我具有好」）」；"han
        narsese"「（外交，【词项，任一独立变量，其一非独变量】，【所问查询变量，操作操作】）似【词项，任一独立变量，其一非独变量，所问查询变量，操作操作】」"han
        narsese"「（内交，【词项，任一独立变量，其一非独变量，所问查询变量】，【所问查询变量，操作操作】）似【所问查询变量】」"han
        narsese"「（内差，【词项，任一独立变量，其一非独变量】，【词项】）似【任一独立变量，其一非独变量】」"han
        narsese"（与，「『爱因斯坦』是物理学家」，「（外像，某，研发出，相对论）是『爱因斯坦』」）。"han
        narsese"「（与，「任一人是【会死的】」，「『苏格拉底』是人」）得「『苏格拉底』是【会死的】」」。"han
        narsese"「（接连，「时间是黑夜」，「程序员有写代码」，「（外像，程序员，撞上，某）是bug」）将得「程序员是【熬夜的】」」。"han
        narsese"「（同时，「系统有开放性」，「系统有自主性」，「系统有实时性」）将得「系统是AGI」」？"han
